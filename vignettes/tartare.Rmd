...
abstract: |
  ...
  binary file format (.raw) [@RawfileReader2015]. The intention behind tartare
  ...
  The package is considered to be used with the `r BiocStyle::Biocpkg("rawrr")`
  package [@Kockmann2021], `r BiocStyle::Biocpkg("Spectra")` and
...
More example code snippets are shown in the package vignette of the  `r BiocStyle::Biocpkg("MsBackendRawFileReader")` package.
